...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      {/* subtle top glow */}
      <div
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(60%_50%_at_70%_0%,rgba(129,140,248,0.18),rgba(2,6,23,0)_60%)]"
        aria-hidden="true"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:py-28">
        ...
        <h1 className="max-w-3xl text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
          ...
          <br /> kits that actually ship.
        </h1>

        {/* lead paragraph (updated copy) */}
        ...
        <ul className="mt-8 space-y-3 text-white/80">
          <li className="flex gap-3">
            ...
            <div>
              ...
              Reply to customers in your tone with context pulled from the
              thread.
            </div>
          </li>
          ...
          <li className="flex gap-3">
            ...
            <div>
              ...
              Show the value of automation to your team in dollars saved per
              week.
            </div>
          </li>
        ...
        {/* CTA row (primary only) */}
        <div className="mt-10">
          <Link
            href="/signup"
            className="inline-flex items-center rounded-xl border border-white/10 bg-white px-5 py-3 text-sm font-medium text-slate-900 hover:bg-slate-100 transition"
          >
            Get started
          </Link>
        </div>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-white/70">
              Draft customer replies in one click with thread context and your
              brand tone.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-white/70">
              Auto-tag, prioritize, and route support tickets to the right
              owner.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-white/70">
              Upload meeting audio and get clean summaries, action items, and
              owners.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-white/70">
              Estimate hours saved and cost reduction from each kit to share
              with stakeholders.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <p className="mt-2 text-sm text-white/70">
              Prebuilt Zapier recipes to connect your tools in minutes—no prompt
              wrangling.
            </p>
          </div>
